...
# ====================== for using RepVGG as the backbone of a bigger model, e.g., PSPNet, the pseudo code will be
# like train_backbone = create_RepVGG_B2(deploy=False) train_backbone.load_state_dict(torch.load(
# 'RepVGG-B2-train.pth')) train_pspnet = build_pspnet(backbone=train_backbone) segmentation_train(train_pspnet)
# deploy_pspnet = repvgg_model_convert(train_pspnet) segmentation_test(deploy_pspnet) =====================
