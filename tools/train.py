...
#     parser.add_argument('--config', default="/home/cuidongdong/BEVDet/configs/bevdet/bevdet-r50.py", help='train config file path')
...
#         cfg.work_dir = osp.join('./outputs_resnet50_analysis', osp.splitext(osp.basename(args.config))[0])
...
#         print("datasets is: ", datasets.__len__())
