...
def parse_args():
    ...
    parser.add_argument(
        '--resume-from',
        default="/home/cuidongdong/BEVDet/outputs_mobilenetv2_inception_1/bevdet_mobilenetv2_inception/epoch_49.pth",
...
def main():
    ...
    if args.work_dir is not None:
        ...
        cfg.work_dir = osp.join('./outputs_mobilenetv2_inception_1', osp.splitext(osp.basename(args.config))[0])
